...
- research:
- nwaku:
  - Deprecate rln-relay-tree-path cli argument in wakunode2 app
- js-waku:
- chat: 
...
- [[Deliverable] SDS protocol in Status - basic integration](https://github.com/waku-org/pm/issues/194)
  ...
  - next:
  - blockers:
    - [nwaku] Make status-desktop and status-go CI green has been paused because status-go is stopping using vendor folder and usual go get approach. We will resume this task upon unlocking.
...
- [[Deliverable] Forum PoC](https://github.com/waku-org/pm/issues/292)
  - achieved:
    - [chat] extracted library out of opchan (opchan.app uses this library)
  - next:
  - blockers:

- [[Deliverable] Reliable Qaku & library](https://github.com/waku-org/pm/issues/287)
  - achieved:
    - [chat] SCALA - Secure CALendar App - https://preview--sync-shards-cal.lovable.app/ https://forum.logos.co/t/scala-secure-calendar-app/1355
  - next:
  - blockers:
...
- [[Deliverable] 5-10 Highly qualified leads](https://github.com/waku-org/pm/issues/254)
  - achieved:
    - [chat] Many useful connections at Cypherpunk Retreat (Brave, Tor, FtC, Internet Archive...)
  - next:
  - blockers:
