...
- [Survey impact of message rate and size limit](https://github.com/waku-org/pm/issues/277)
  - achieved:
    - [chat] [started conversation on RLN UX](https://www.notion.so/RLN-Rate-Limit-Nullifier-UX-1768f96fb65c806fbd19de8e1f28912b)
  - next:
    - [chat] agree on a UX for RLN
  - blockers:
...
- [Minimal solution for greedy messages](https://github.com/waku-org/pm/issues/265)
  - achieved:
    - [chat] testing shard 128 for status messages on [this branch](https://github.com/status-im/status-go/tree/shard-128)
  - next:
    - [chat] test backup/sync on shard 128
  - blockers:
