...
- [[Deliverable] Define and implement sharding for Communities messages](https://github.com/waku-org/pm/issues/266)
  - achieved:
  - next:
    - [chat] add tests to community sharding stage 1
  - blockers:
...
- [[Deliverable] SDS protocol in Status - basic integration](https://github.com/waku-org/pm/issues/194)
  - achieved:
  - next:
    - [nwaku] Merge [sds integration PR](https://github.com/status-im/status-go/pull/6884) in status-go
  - blockers:
...
- [[Deliverable] Chat SDK Developer Preview](https://github.com/waku-org/pm/issues/316)
  - achieved:
    - [chat] [draft implementation of nim noise KN pattern](https://github.com/threeproto/nim-noise)
  - next:
    - [chat] test the noise implementation
  - blockers:
...
- [[Deliverable] Create Segmentation Library](https://github.com/waku-org/pm/issues/318)
  - achieved:
    - [chat] [segmentation specs](https://github.com/waku-org/specs/pull/91)
  - next:
  - blockers:
