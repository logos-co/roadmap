...
- research:
- nwaku:
  - Deprecation of sync/local Merkle tree completed.
- js-waku:
- chat:
...
- [Define and implement sharding for Communities messages](https://github.com/waku-org/pm/issues/266)
  - achieved:
    - [chat] [stage 1 communities in own shard](https://github.com/status-im/status-go/pull/6573)
  - next:
  - blockers:
...
- [Private chat rate limit PoC](https://github.com/waku-org/pm/issues/277)
  - achieved:
    - [chat] [update the kv_store PR](https://github.com/status-im/status-go/pull/6513)
  - next:
  - blockers:
...
- [Reliable Qaku & library](https://github.com/waku-org/pm/issues/287)
  - achieved:
    - [chat] Logos Core container & GH action: https://github.com/logos-co/logos-core-poc/pull/2, https://github.com/logos-co/logos-core-poc/pull/4
  - next:
    - [chat] Qaku
...
## [Maintenance H1 2025](https://github.com/waku-org/pm/issues/275)
  ...
  - blockers:
    - [js-waku] [unskip interop tests](https://github.com/waku-org/js-waku/issues/2350)
