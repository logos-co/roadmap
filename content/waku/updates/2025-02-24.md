...
- nwaku:
- js-waku: sds logic for sent and received messages, lightPush background retry
- chat: 
...
- [Scalable Data Sync in browser](https://github.com/waku-org/pm/issues/280)
  ...
  - next:
    - [js-waku] [implement periodic maintenance tasks for incoming and outgoing buffers](https://github.com/waku-org/js-waku/issues/2231)
  - blockers:
...
- [Define Messaging API](https://github.com/waku-org/pm/issues/282)
  - achieved:
  - next:
    - [js-waku] publish rfc covering event based API and basic capabilities
  - blockers:
