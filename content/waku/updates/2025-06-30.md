...
- [End-to-end reliability protocol - Status integration](https://github.com/waku-org/pm/issues/194)
  ...
  - next:
    - [chat] continue the sds integration
  - blockers:
...
- [Private chat rate limit PoC](https://github.com/waku-org/pm/issues/277)
  - achieved:
    - [chat] implement comments on rate limit pr
  - next:
    - [chat] further comments and merge
  - blockers:
...
- [Messaging API: js-waku](https://github.com/waku-org/pm/issues/283)
  - achieved:
    - [js-waku] [fix schedule retry lightPush when no peer available](https://github.com/waku-org/js-waku/issues/2435)
  - next:
