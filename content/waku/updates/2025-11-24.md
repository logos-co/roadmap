...
- [[Deliverable] Nwaku in Status Desktop](https://github.com/waku-org/pm/issues/203)
  - achieved:
    - [nwaku] Validated that StatusDesktop can run on Windows+nwaku. [PR](https://github.com/waku-org/nwaku/pull/3648) submitted to adapt nwaku's Makefile to create libwaku dependency on Windows.
  - next:
  - blockers:
...
- [[Deliverable] Chat SDK Developer Preview](https://github.com/waku-org/pm/issues/316)
  ...
  - next:
    - Waku Delivery service implementation with discovery
  - blockers:
