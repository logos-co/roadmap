...
- [[Deliverable] SDS protocol in Status - basic integration](https://github.com/waku-org/pm/issues/194)
  - achieved:
    - [nwaku] Managed to have green all CI in [integrate nim-sds PR](https://github.com/status-im/status-go/pull/6884). This PR only contains nix and Makefile adaptations to add sds as dependency in status-go. Not merged yet.
  - next:
  - blockers:
