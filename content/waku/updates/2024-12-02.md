...
- next: [nwaku] Implementing a capping mechanism for the peer manager to ensure space is always available for service and relay peers [chore: Reserve % of max connections for relay](https://github.com/waku-org/nwaku/issues/3163).
