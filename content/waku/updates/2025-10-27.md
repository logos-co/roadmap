...
- [[Deliverable] Local Web Dev Harness](https://github.com/waku-org/pm/issues/359)
  - achieved:
    - [js-waku] [create local development environment tools](https://github.com/waku-org/js-waku/issues/2670)
  - next:
    - [js-waku] [document local development environment](https://github.com/waku-org/js-waku/issues/2709)
...
- [Zerokit is used in the Browser for Credentials Management](https://github.com/waku-org/pm/issues/341)
  - achieved:
  - next:
    - [js-waku] [document rln.waku.org for consumers](https://github.com/waku-org/js-waku/issues/2711)
  - blockers:
...
## Maintenance
  ...
  - next:
    - [js-waku] [prepare release](https://github.com/waku-org/js-waku/issues/2706)
  - blockers:
