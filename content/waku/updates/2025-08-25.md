...
- [[Deliverable] Define and implement sharding for Communities messages](https://github.com/waku-org/pm/issues/266)
  - achieved:
    - [chat] fix conflicts with PRs https://github.com/status-im/status-go/pull/6573 https://github.com/status-im/status-go/pull/6588
  - next:
    - [chat] merge prs add tests
  - blockers:
...
- [[Deliverable] Chat SDK Developer Preview](https://github.com/waku-org/pm/issues/316)
  - achieved:
    - [fix the nwaku nimble dependencies](https://github.com/waku-org/nwaku/pull/3555)
  - next:
    - continue the nwaku integration in chat-sdk
  - blockers:
...
- [[Deliverable] Create Rate Limit Manager](https://github.com/waku-org/pm/issues/319)
  - achieved:
    - [chat] [exposing message status and current capacity in rate limit](https://github.com/waku-org/nim-chat-sdk/pull/9)
  - next:
  - blockers:
...
- [[Deliverable] Reliable Qaku & library](https://github.com/waku-org/pm/issues/287)
  - achieved:
    - [chat] Updates to dispatcher for constellation work
    - [chat] PoC Waku x Miden
  - next:
  - blockers:
