...
- [Nwaku on Windows](https://github.com/waku-org/pm/issues/239)
  - achieved:
    - [nwaku] Simplified prerequisites and fine-tuned configurations for Wakunode and Libwaku
  - next:
    - [nwaku] Test the Windows build (“dogfooding”) across various environments and machines
  - blockers:
...
- [Specify private chat protocol](https://github.com/waku-org/pm/issues/285)
  ...
  - next:
    - [chatresearch] Understand & document the areas that are most suspect. Namely; Multi Device handling, Session Initiation, Authentication
  - blockers:
...
- [Reliable Qaku & library](https://github.com/waku-org/pm/issues/287)
  - achieved:
    - [chat] [extracting library from front end](https://github.com/vpavlin/qaku/pull/19)
  - next:
  - blockers:
