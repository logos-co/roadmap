...
- [Private chat rate limit PoC](https://github.com/waku-org/pm/issues/277)
  - achieved:
    - [chat] [kv store in status-go and handle rate limit state updates](https://github.com/status-im/status-go/pull/6475)
  - next:
    - [chat] desktop UI for rate limit
  - blockers:
...
- [Status Local Metrics](https://github.com/waku-org/pm/issues/273)
  - achieved:
    - [chat] [refactor and update bandwidth metrics](https://github.com/status-im/status-go/pull/6406)
  - next:
  - blockers:
...
## [Maintenance H1 2025](https://github.com/waku-org/pm/issues/275)
  - achieved:
    - [chat] Some post-hackathon cleanup of WhisperBox code
  - next:
