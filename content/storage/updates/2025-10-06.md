...
6. [NAT support](https://github.com/codex-storage/nim-codex/issues/904)
   ...
   - Researched how `nwaku` utilizes both libp2p NAT traversal and UPnP.
   - [Started implementation of the NAT and reachability detection using AutoNAT](https://github.com/codex-storage/nim-codex/issues/1319).
