...
* [**v2.1.0 of the Logos storage module is out**](https://github.com/logos-co/logos-storage-module/releases/tag/v2.1.0). It brings libstorage v0.4.2 with major improvements to NAT traversal as well as other bugfixes and improvements. Make sure to check [the release notes](https://github.com/logos-storage/logos-storage-nim/releases/tag/v0.4.2) for more details.
