...
- [Status Private Chats](/messaging/furps/application/status_private_chats.md): all
...
3. **Global Network Metrics**: Moved to a new milestone - [Improve DevEx: API, TWN, Metrics, Docs](2025-improve-devex.md). 
