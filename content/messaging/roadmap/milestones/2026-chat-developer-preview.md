...
This is **not** a public release with published documentation. The focus is:
...
### Implement on-chain contact discovery

**Owner**: Chat Team

Replace v0.1's out-of-band intro bundle sharing with on-chain storage of contact discovery information on Logos Blockchain. This removes the need for users to manually share invite links.
