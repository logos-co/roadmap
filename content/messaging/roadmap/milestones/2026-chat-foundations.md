...
Identity is limited to installation keys (one keypair = one client instance). There is no concept of a "user" spanning multiple devices — that is deferred to [Chat — Developer Preview](2025-extend-chat-sdk-with-group-conversations).
