...
- [[Deliverable] SDS protocol in Status - basic recovery](https://github.com/waku-org/pm/issues/304)
  ...
  - next:
  - blockers:
    - basic discovery of sds integration blocked by this issue, https://github.com/status-im/status-go/issues/7216
...
- [[Deliverable] Chat SDK Bindings](https://github.com/waku-org/pm/issues/317)
  - achieved:
    - [logos] [c-bindings pr](https://github.com/logos-messaging/nim-chat-poc/pull/47)
  - next:
  - blockers:
...
- [Create nim-ffi](https://github.com/waku-org/pm/issues/332)
  - achieved:
    - [nim] [Use nim-ffi dependency in logos-messaging-nim](https://github.com/logos-messaging/logos-messaging-nim/issues/3655)
  - next:
  - blockers:
