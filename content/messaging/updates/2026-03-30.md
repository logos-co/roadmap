...
- [[Deliverable] Introduce Messaging API in Logos Delivery](https://github.com/logos-messaging/pm/issues/305)
  - achieved:
    - [delivery] [implement subscribe and receive API](https://github.com/logos-messaging/logos-delivery/issues/3710)
  - next:
  - blockers:
...
- [[Deliverable] Migrate logos-delivery to Nimble](https://github.com/logos-messaging/pm/issues/377)
  - achieved:
  - next:
    - [delivery] [Start using Nimble](https://github.com/logos-messaging/logos-messaging-nim/pull/3682)
  - blockers:
...
- [[Deliverable] Logos Chat Library](https://github.com/logos-messaging/pm/issues/316)
  - achieved:
    - [chat] Replace embedded waku with delivery module - https://github.com/logos-co/logos-chat-module/pull/20
    - [chat] Implement LogosChat Client - https://github.com/logos-messaging/libchat/pull/73 
    - [chat] Traits for Storage - https://github.com/logos-messaging/libchat/pull/79
  - next:
  - blockers:
...
## Maintenance
  - achieved:
    - [delivery] [bug: Multiple non-flaky test failures in Waku interop tests](https://github.com/logos-messaging/logos-delivery/issues/3758)
    - [delivery] [release/v0.38: failing tests - filter rate limit, relay bandwidth, and auto-sharding NoPeersToPublish](https://github.com/logos-messaging/logos-delivery/issues/3741)
      - [Fix failing test cases on logos-delivery/v0.38](https://github.com/logos-messaging/logos-delivery-interop-tests/pull/165)
  - next:
    - [delivery] [Adjust changelog.md for v0.38.0](https://github.com/logos-messaging/logos-delivery/pull/3760)
    - [delivery] Integrate SDS in logos-delivery and implement SDS-R
    - [delivery] Improving waku-canary reliability in uptime
    - [delivery] [chore: createNode security hardening + source move to src](https://github.com/logos-co/logos-delivery-module/pull/5)
  - blocked:
