...
- [[Deliverable] SDS protocol in Status - basic integration](https://github.com/waku-org/pm/issues/194)
  - achieved:
  - next:
    - [nwaku] Confirm current sds integration fits well in Status-Desktop [chore: status-go with nim-sds](https://github.com/status-im/status-desktop/pull/19402)
  - blockers:

- [[Deliverable] SDS protocol in Status - basic recovery](https://github.com/waku-org/pm/issues/304)
  - achieved:
    - [chat] send message with sds in status-go, https://github.com/status-im/status-go/pull/7149
  - next:
  - blockers:
    - [chat] sds go bindings is reverted with status desktop build issues, https://github.com/status-im/status-go/pull/7156
