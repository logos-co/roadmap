...
- [[Deliverable] Nwaku in Status Desktop](https://github.com/waku-org/pm/issues/203)
  - achieved:
    - [nwaku] [Complete nwaku integration (timesource)](https://github.com/status-im/status-go/pull/7148)
  - next:
    - [nwaku] Remove all go-waku references from within status-go/messaging/waku/nwaku.go file
  - blockers:
...
- [[Deliverable] SDS protocol in Status - basic integration](https://github.com/waku-org/pm/issues/194)
  - achieved:
    - [nwaku] [Confirm current sds integration fits well in Status-Desktop](https://github.com/status-im/status-desktop/pull/19402)
  - next:
  - blockers:
...
- [[Deliverable] Introduce Waku API in nwaku](https://github.com/waku-org/pm/issues/305)
  - achieved:
    - [nwaku] [EventBroker has been introduced](https://github.com/waku-org/nwaku/pull/3644)
  - next:
...
- [Create nim-ffi](https://github.com/waku-org/pm/issues/332)
  - achieved:
  - next:
    - [nwaku] [Use external nim-ffi repository](https://github.com/logos-messaging/nwaku/issues/3655)
  - blockers:
