...
The AnonComms team is currently working on the following milestones:

1. [Create a basic capability discovery module for Logos Core](./create_basic_capability_discovery_module.md), by defining an efficient capability discovery protocol over libp2p kad-DHT.
