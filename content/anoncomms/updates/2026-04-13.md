...
- Opened both a [spec](https://github.com/vacp2p/rfc-index/pull/311) and [implementation](https://github.com/vacp2p/nim-libp2p/pull/2243) for cover traffic generation in libp2p mix
