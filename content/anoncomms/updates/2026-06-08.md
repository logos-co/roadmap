...
- Implement basic λAccount library
  - achieved:
    - Account Registry Publication: https://github.com/logos-messaging/libchat/pull/129
    - Cross crate External Identity Provider: https://github.com/logos-messaging/libchat/pull/127
  - next:
    - Merge PRs
...
- [Specify and implement RLN membership allocation service](https://github.com/logos-co/anoncomms-pm/issues/17)
  - achieved: Update logos-core modules to work with latest basecamp, monitoring module for visualization end-to-end simulation of protocol
  - next: Prepare presentation of work done so far for town hall
