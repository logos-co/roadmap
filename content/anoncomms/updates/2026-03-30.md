...
- Specify and implement extended DoS and exit node abuse protection for libp2p mix
    - achieved: 
        - migrated [mix-rln-plugin](https://github.com/logos-co/mix-rln-spam-protection-plugin/pull/4) to use zerokit 2.0.0, implemented mix delay strategy improvements
        - Analysis revisiting sender generated proof with a broader comparison of both approaches [here](https://www.notion.so/Revisiting-Sender-Generated-Proofs-for-RLN-DoS-Protection-in-Mix-3308f96fb65c80cca525fe593f083a4f?source=copy_link).
...
- Release Zerokit (v2.0.0) for multi-ID burning and partial proof generation
    - achieved: patch PRs ([397](https://github.com/vacp2p/zerokit/pull/397), [398](https://github.com/vacp2p/zerokit/pull/398)), pubished [blogpost](https://forum.research.logos.co/t/rln-partial-proofs-in-practice/686)
