...
- [PR #678](https://github.com/logos-blockchain/logos-blockchain/pull/678) DA Protobufs: DA Prost integration merged - generates rust structures for protofiles as a build step.
- [PR #681](https://github.com/logos-blockchain/logos-blockchain/pull/681) DA Protobufs: DA Network message types merged - Dispersal, Replication, and Sampling protocols defined as protofiles and exposed as a module in `nomos-da/network/messages`.
- [PR #679](https://github.com/logos-blockchain/logos-blockchain/pull/679) CI Improvements - DA Indexer integration tests improvement merged - Integration test now better determines when to expect a specific `blob_id` in a block received via the network. This test will be used with the new DA dispersal protocol.
...
- [PR #680](https://github.com/logos-blockchain/logos-blockchain/pull/680) - started implementing DA network stack: sketched up crates, created basic structure for 3 subprotocols (dispersal, replication, sampling), implemented Replication subprotocol (non-working, we have a bug). Also added base contract for the DA networking layer on the nomos node. That way we can start integrating it into the DA services.
- [PR #683](https://github.com/logos-blockchain/logos-blockchain/pull/683) - added DA network adapter trait in mempool (first step in adapting the mempool to continuously sample and verify).

## `PPoS/Consensus`

### `Research`

- [PR #10](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/10) - 1st Proof of Validator PR in Circom with Merkle tree.
...
- [PR #9](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/9) - Proof of Leadership spec implementation in risc0.
...
- [PR #8](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/8) - Nomos native zone deposit tx.
- WIP: Nomos native zones bridge deposit.
- [PR #11](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/11) - added death constraints to the transfer scenario; in this scenario, we don't do any interesting account abstraction so the death constraints are proofs of no-ops. With this change, CL is "feature complete" for the purposes of the PoC.
...
- [PR #682](https://github.com/logos-blockchain/logos-blockchain/pull/682) CI Improvements - Protoc build deps for testnet and Jenkins CI merged.
- [PR #684](https://github.com/logos-blockchain/logos-blockchain/pull/684) Rust 1.80 (opened, not merged yet) - added an `allow[dead_code]` for `Nonce` in consensus for Clippy. Unused methods in da libp2p will be handled in separate PRs.
