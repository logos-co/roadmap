...
- [PR #810](https://github.com/logos-blockchain/logos-blockchain/pull/810) (Node) - Executor: Dispersal service mempool adapter.
- [PR #811](https://github.com/logos-blockchain/logos-blockchain/pull/811) (Node) - Implemented a tiny executor HTTP client.
- [PR #812](https://github.com/logos-blockchain/logos-blockchain/pull/812) (Node) - Executor: Dispersal service in executor node.
- [PR #814](https://github.com/logos-blockchain/logos-blockchain/pull/814) (Node) - Executor: Dispersal HTTP endpoint.
- [PR #815](https://github.com/logos-blockchain/logos-blockchain/pull/815) (Node) - Implemented executor sampling adapter.
- [PR #816](https://github.com/logos-blockchain/logos-blockchain/pull/816) (Node) - Implemented executor verifier adapter.
- [PR #817](https://github.com/logos-blockchain/logos-blockchain/pull/817) (Node) - Executor: Indexer types for different nodes.
- [PR #818](https://github.com/logos-blockchain/logos-blockchain/pull/818) (Node) - Worked on testing/debugging the DA main test, created missing pieces, and refactored tests to include executors.
...
- Reviewed an issue related to FK20, which turned out not to be an issue. The necessary explanation is provided [here](https://github.com/logos-blockchain/logos-blockchain/issues/809#issuecomment-2397536374).
...
- [PR #813](https://github.com/logos-blockchain/logos-blockchain/pull/813) (Node) - updated the benchmarks and added them to the CI.
