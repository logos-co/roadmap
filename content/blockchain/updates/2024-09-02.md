...
- [PR #704](https://github.com/logos-blockchain/logos-blockchain/pull/704) (Node) - added the DA Network to the Nomos Node.
- [PR #705](https://github.com/logos-blockchain/logos-blockchain/pull/705) (Node) - finalized Sampling Service PR without backend.
- [PR #706](https://github.com/logos-blockchain/logos-blockchain/pull/706) (Node) - fixes and updates to traits, service implementation, and libp2p network backend implementation.
- [PR #708](https://github.com/logos-blockchain/logos-blockchain/pull/708) (Node) - (WIP) plugging sampling into consensus.
- [PR #709](https://github.com/logos-blockchain/logos-blockchain/pull/709) (Node) - implemented the backend (including tests). Currently in review.
- [PR #710](https://github.com/logos-blockchain/logos-blockchain/pull/710) (Node) - implemented a few fixes to the sampling service backend.
- [PR #711](https://github.com/logos-blockchain/logos-blockchain/pull/711) (Node) - added integration tests for dispersal using Nomos Cli.
- [PR #712](https://github.com/logos-blockchain/logos-blockchain/pull/712) (Node) - added the sampling service rng suggestion to the Nomos Node.
- [PR #713](https://github.com/logos-blockchain/logos-blockchain/pull/713) (Node) - added the Verifier and Indexer to the Nomos Node.

## `PPoS/Consensus`

### `Research`

- [PR #114](https://github.com/logos-blockchain/logos-blockchain-specs/pull/114) (Nomos-specs) - included the PoL using (using the randomness of the last PoL for the slot) in the code spec.
