...
- Lock Overwatch to a specific revision in nomos: https://github.com/logos-blockchain/logos-blockchain/pull/455.
...
- Add API to return mempool item status: https://github.com/logos-blockchain/logos-blockchain/pull/449.
- Make libp2p gossipsub settings configurable: https://github.com/logos-blockchain/logos-blockchain/pull/454.
- Avoid temporary gossipsub errors when bootstrapping tests: https://github.com/logos-blockchain/logos-blockchain/pull/442.

## `testnet:`

### `development:`

- Skeleton for nomos API service - https://github.com/logos-blockchain/logos-blockchain/pull/451.
- Support generics for overwatch derive - https://github.com/logos-co/Overwatch/pull/26.
- Fix clippy warnings for rust 1.73 - https://github.com/logos-blockchain/logos-blockchain/pull/452.
- Remove waku mentions from codebase - https://github.com/logos-blockchain/logos-blockchain/pull/446.
- Improved integration tests.
- Handle corner cases in the unhappy path: https://github.com/logos-blockchain/logos-blockchain/pull/438.
- Add canonical ID to attestations and certificates: https://github.com/logos-blockchain/logos-blockchain/pull/448.
- Add functionalities to nomos-cli: https://github.com/logos-blockchain/logos-blockchain/pull/450.
...
- DA nomos API based on the new skeleton: https://github.com/logos-blockchain/logos-blockchain/pull/456.
- Add API to return DA blobs: https://github.com/logos-blockchain/logos-blockchain/pull/453.