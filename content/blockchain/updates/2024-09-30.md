...
- [PR #764](https://github.com/logos-blockchain/logos-blockchain/pull/764) (Node): DA - Finished and merged replication changes.
- Kickoff executor binary: We plan to add missing pieces of the architecture for the testnet. The first step is having a running executor. [PR #766](https://github.com/logos-blockchain/logos-blockchain/pull/766) (Node) - created the binary crate. [PR #768](https://github.com/logos-blockchain/logos-blockchain/pull/768) (Node) - implemented (composed) executor network behaviors and added Swarm. [PR #795](https://github.com/logos-blockchain/logos-blockchain/pull/795) (Node) (WIP) - started network service implementation.
...
- [PR #797](https://github.com/logos-blockchain/logos-blockchain/pull/797) (Node) - KZG-RS global params configuration for the testnet: updated configuration syncing between nodes and added Risc0 dependencies. After review, this can be deployed on testnet.nomos.tech.
- [PR #767](https://github.com/logos-blockchain/logos-blockchain/pull/767) and [PR #770](https://github.com/logos-blockchain/logos-blockchain/pull/770) (Node) - CI: Jenkins nightly jobs update - Risc0 setup for Jenkins nightlies. Added dissemination test alongside consensus. Docker build job for GitHub PR check to track missing dependencies.
