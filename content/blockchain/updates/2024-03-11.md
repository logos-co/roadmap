...
- We have updated the Cryptarchia specification with the update epoch stabilization schedule - [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/79).
...
- Removed assumptions on Carnot being the consensus algorithm in the mempool: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/605).
- Separate ledger and consensus to prepare for integration: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/606).
...
- [All PRs](https://github.com/logos-blockchain/logos-blockchain/pull/569) for Mixnet v1 implementation have been merged. We've taken some additional time to polish the code according to feedback.
...
- Finished RS core encode/decode: there was an issue with different FFT calls from different libraries that didn't work and took a while to debug. They use floating numbers, and when rounding or using a big set of operations, precision leads to errors - [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/75).
- Implemented DA protocol encoder: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/76).
- Implemented DA protocol verifier: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/78).
- DA API mempool tests using a mock implementation [PR](https://github.com/logos-blockchain/logos-blockchain/pull/604) - The previous PR defined an abstraction for verifying and filtering what to include in the generic mempool; this PR provides mock implementations for TX and Cert verification/filtering. WIP: DA API indexing for data blobs - adding an index to data blob in DA node when the certificate is observed in the block.
...
- Explorer works well now, can share the data directories with the node, and provide data through HTTP: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/603).
