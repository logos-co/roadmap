...
- [PR #826](https://github.com/logos-blockchain/logos-blockchain/pull/826) (Node) - Added handling for automatic reconnections in the dispersal executor behavior. This should significantly improve network stability for executors. After a few iterations, we found the correct approach.
- [PR #828](https://github.com/logos-blockchain/logos-blockchain/pull/828) (Node) - Removed unnecessary extra channels from the consensus adapter.
- [PR #832](https://github.com/logos-blockchain/logos-blockchain/pull/832) (Node) - Tests: General configuration and multiple nodes. Refactored integration tests to have a general configuration for common services in validator and executor nodes.
- [PR #835](https://github.com/logos-blockchain/logos-blockchain/pull/835) (Node) - Started the integration of the Coordination Layer in the node by adding the transaction definition format and cleaning the code by removing Carnot leftovers.
...
- [PR #822](https://github.com/logos-blockchain/logos-blockchain/pull/822) and [PR #823](https://github.com/logos-blockchain/logos-blockchain/pull/823) (Node) - Added the mix service.
- [PR #824](https://github.com/logos-blockchain/logos-blockchain/pull/824) and [PR #829](https://github.com/logos-blockchain/logos-blockchain/pull/829) (Node) - Integrated the mix service into the node.
...
- [PR #820](https://github.com/logos-blockchain/logos-blockchain/pull/820) (Node) - CI: Added a self-hosted MacOS runner with metal support (in coordination with the Infra team). Additional configuration is needed for specific test cases, but now we have the capability to do it ourselves.
