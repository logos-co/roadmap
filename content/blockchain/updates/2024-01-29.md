...
- The PRs that entail the changes and piece them all together in the executable mixnet specification can be found [here](https://github.com/logos-blockchain/logos-blockchain-specs/pull/56) and [here](https://github.com/logos-blockchain/logos-blockchain-specs/pull/57).

### `development`

- Added a couple of PRs in preparation for the mixnet rust development - [crate structure](https://github.com/logos-blockchain/logos-blockchain/pull/570), [remove mixnet legacies 1](https://github.com/logos-blockchain/logos-blockchain/pull/572), and [remove mixnet legacies 2](https://github.com/logos-blockchain/logos-blockchain/pull/573).

## `testnet`

### `development`

- Started the [document](https://www.notion.so/Block-Explorer-4d32e6f08c144a3a9166d25512e0e339) on the design of Block Explorer 2. Also, added a [PR](https://github.com/logos-blockchain/logos-blockchain/pull/566) regarding naive blocks query implementation from the storage layer (the PR is still open with an ongoing discussion).
- Added a testnet basic bot to the chatapp non-interactive mode ([PR](https://github.com/logos-blockchain/logos-blockchain/pull/567)). In more detail, we have previously added the ability to disseminate a file to the DA in the testnet, and we updated the chatapp with a similar functionality, which is used to have a bot that constantly pushes readable data to our DA in the testnet. This data (as opposed to file upload) will be readable by our testnet users and will be useful during the demos.
- Container for the basic bot [PR](https://github.com/logos-blockchain/logos-blockchain/pull/568) - performed some required changes to our testnet infrastructure.
...
- The initial version of the Cryptarchia executable specification [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/54) has been merged.
- Added [fork choice rule](https://github.com/logos-blockchain/logos-blockchain-specs/pull/58) to the Cryptarchia executable specification.
- Merged [implementation of slot leader election check](https://github.com/logos-blockchain/logos-blockchain-specs/pull/55) to the Cryptarchia executable specification.
