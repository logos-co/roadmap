...
- Some ideas and improvements were registered (low priority): [Verified Certificate state](https://github.com/logos-blockchain/logos-blockchain/issues/646) and [Investigate BlobDB storage](https://github.com/logos-blockchain/logos-blockchain/issues/645).
