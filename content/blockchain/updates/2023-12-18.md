...
- Solved [an issue](https://github.com/logos-blockchain/logos-blockchain/pull/544](https://github.com/logos-blockchain/logos-blockchain/pull/544 "https://github.com/logos-blockchain/logos-blockchain/pull/544)  that was causing problems with simulations (Carnot 10k nodes - Tree implementation returned different results when searching for child committee and then using child committee to find its parent)
...
- The new read/write DA API is still in progress - there are conversations ongoing which can be seen in the [draft PR](https://github.com/logos-blockchain/logos-blockchain/pull/546)
