...
- Tune timeouts (by heavy debugging): 
	- https://github.com/logos-blockchain/logos-blockchain/pull/492 
	- https://github.com/logos-blockchain/logos-blockchain/pull/494 
- Prevent Duplicate error from libp2p gossipsub broadcasting: https://github.com/logos-blockchain/logos-blockchain/pull/498 
- Fix port conflict: https://github.com/logos-blockchain/logos-blockchain/pull/504 
- Store CI artifacts: 
	- https://github.com/logos-blockchain/logos-blockchain/pull/508  
	- https://github.com/logos-blockchain/logos-blockchain/pull/510 
- Mixnet implementation improvement
- Mixclient reconnect: https://github.com/logos-blockchain/logos-blockchain/pull/501 
...
- Services APIs: 
	- https://github.com/logos-blockchain/logos-blockchain/pull/476  
	- https://github.com/logos-blockchain/logos-blockchain/pull/487  
	- https://github.com/logos-blockchain/logos-blockchain/pull/488  
	- https://github.com/logos-blockchain/logos-blockchain/pull/489 
- Mempool aware of included blocks: https://github.com/logos-blockchain/logos-blockchain/pull/485
- Voter attestation: https://github.com/logos-blockchain/logos-blockchain/pull/498 
- Community PRs - typos: 
	- https://github.com/logos-blockchain/logos-blockchain/pull/503  
	- https://github.com/logos-blockchain/logos-blockchain/pull/481 
- Http API integration (Made the CI all green for the integrating PRs): https://github.com/logos-blockchain/logos-blockchain/pull/490 
- Chat demo: https://github.com/logos-blockchain/logos-blockchain/pull/495 
- Nomos node types (extract common types from nomos-node crate): https://github.com/logos-blockchain/logos-blockchain/pull/496 
- Nomos update for demo call: [Notion link](https://www.notion.so/Nomos-update-November-2023-3b9a90935fce4e9083e6111210d0f101) 
- Static testnet configuration: https://github.com/logos-blockchain/logos-blockchain/pull/499 
...
- To have testnet properly deployed and available at nomos.tech domain, we need to deploy it on - New API: https://github.com/logos-blockchain/logos-blockchain/pull/509 
- Implement a basic version concrete error for Overwatch: https://github.com/logos-co/Overwatch/pull/32 
- Remove included  blocks from mempool: https://github.com/logos-blockchain/logos-blockchain/pull/485
- DA utilities: https://github.com/logos-blockchain/logos-blockchain/pull/493  
- Rework consensus API: https://github.com/logos-blockchain/logos-blockchain/pull/502 
- Include block ID during serialization of carnotinfo:
- https://github.com/logos-blockchain/logos-blockchain/pull/505  
- Opened a new issue: https://github.com/logos-blockchain/logos-blockchain/issues/506 
