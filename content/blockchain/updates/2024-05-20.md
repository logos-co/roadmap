...
- DA Verifier service implementation: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/627) merged: the service for attesting the blobs.
...
- The Atomic Asset Transfer case has been started, but the text and diagrams lacked rigor. An implementation of the CL [executable spec](https://github.com/logos-blockchain/logos-blockchain-specs/pull/93) has begun, which can better sanity check the design. Details on Noir ZK language integration with Python: [here](https://github.com/logos-blockchain/logos-blockchain-specs/pull/92).
