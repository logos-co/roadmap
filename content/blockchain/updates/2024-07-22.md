...
- [PR #6](https://github.com/logos-blockchain/logos-blockchain-simulations/pull/6): The initial mixnet simulation is ready to be reviewed. This PR has some missing pieces that will be added in the next PRs (to make the PR smaller and easily check if the simulation works correctly).
- [PR #7](https://github.com/logos-blockchain/logos-blockchain-simulations/pull/7): Now using gossiping for broadcasting after mix.
- [PR #9](https://github.com/logos-blockchain/logos-blockchain-simulations/pull/9): Added dissemination time measurement.
...
- [PR #100](https://github.com/logos-blockchain/logos-blockchain-specs/pull/100): Direct DA connection protocol - added session control message type, simplified Dispersal and Sample error messages. This has been merged into the `da-poc` branch, it's now in the nomos-poc repo.
- [PR #5](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/5): DA feasibility test for a large number of UDP connections - investigated how a large number of connections would affect different network topologies.
- [PR #6](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/6) (moved from `nomos-specs`): Finalized and merged the PoC PR. Based on this, the [documentation](https://www.notion.so/Proof-of-Concept-Data-Availability-Dispersal-Sampling-50f204f2ff0a41d09de4926962bbb4ef?d=9e9677e5536a46d49fe95f366b7c3320#308624c50f1a42769b6c142976999483) has been updated accordingly.
...
- [PR #3](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/3) added - for Proof of Leadership circuits (in circom).
- [PR #106](https://github.com/logos-blockchain/logos-blockchain-specs/pull/106): Defined and implemented the input proof. The input proof verifies the statement that the ptx input has a valid nullifier, the balance commitment was computed correctly, and reveals a death commitment that was used to spend the note.
- [PR #4](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/4): Balance commitments had a design bug that had broken input/output unlinkability, now resolved.
- [PR #7](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/7): Transfer PoC. This introduced 2 more types of CL proofs: Output and Bundle proofs. Also built up the proof infra around this to allow constructing a fully proved transfer transaction that could be placed on chain.
- [PR #2](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/2): Defined and implemented the first version of zone funds death constraints.
