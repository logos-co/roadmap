...
- [PR #715](https://github.com/logos-blockchain/logos-blockchain/pull/715/files) (Node) - implemented DA network in the verifier libp2p adapter.
- [PR #722](https://github.com/logos-blockchain/logos-blockchain/pull/722) (Node) - implemented trigger sampling from DA mempool.
- [PR #723](https://github.com/logos-blockchain/logos-blockchain/pull/723) and [PR #725](https://github.com/logos-blockchain/logos-blockchain/pull/725) (Node) - implemented trigger sampling in Node.
- [PR #729](https://github.com/logos-blockchain/logos-blockchain/pull/729) (Node) - first attempt at storage relay (closed due to incompatible types).
- [PR #730](https://github.com/logos-blockchain/logos-blockchain/pull/730) (Node) - implemented incoming sampling request handling.
- [PR #731](https://github.com/logos-blockchain/logos-blockchain/pull/731) (Node) - implemented adding column index in the sample requests.
- [PR #732](https://github.com/logos-blockchain/logos-blockchain/pull/732) (Node) - implemented `get_blob` on sampling RocksDB adapter.
- [PR #733](https://github.com/logos-blockchain/logos-blockchain/pull/733) (Node) - implemented minimal correct configuration for two nodes participating in DA network to receive BlobInfo into a mempool, start sampling, propose a block with BlobInfo, and eventually provide available blobs via the indexer API for the requested AppID and range.

## `PPoS/Consensus`

### `Research`

- [PR #114](https://github.com/logos-blockchain/logos-blockchain-specs/pull/114) (nomos-specs) - added the first PR for the PoL Python spec.
...
- [First attempt branch](https://github.com/logos-blockchain/logos-blockchain/tree/PoE) for PoE spec (working but not acceptable in terms of cycles).
...
- [PR #718](https://github.com/logos-blockchain/logos-blockchain/pull/718) and [PR #721](https://github.com/logos-blockchain/logos-blockchain/pull/721) (Node) - integration of leadership proofs in the node. We have an issue mostly around long CI times, and we might cut some corners at some point to unblock things until we get more powerful runners.
...
- [PR #726](https://github.com/logos-blockchain/logos-blockchain/pull/726) and [PR #727](https://github.com/logos-blockchain/logos-blockchain/pull/727) (Node) - CI: Investigated Risc0 installation options. Apart from Metal not being available in GitHub runners, we also ran out of disk space. A self-hosted runner would be a solution - [Infra Request](https://github.com/status-im/infra-misc/issues/364).
