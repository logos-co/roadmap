...
- Mixnet network backend skeleton - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/586).
- Libp2p stream read/write - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/587).
- Emitting packets from mixclient using libp2p stream - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/588).
- Handle outputs from mixnode using libp2p stream/gossipsub - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/589).
- Refactor Poisson distribution implementation - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/590).
- Mix client Poisson emission - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/591).
- Mix node packet handling - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/592).
- Mix Packet / Fragment logic - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/593).
- Move FisherYates to nomos-utils - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/594).
- Mixnet topology - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/595).
- Mix client/node unit tests [PR](https://github.com/logos-blockchain/logos-blockchain/pull/596).
...
- WIP: Integration for explorer - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/603) (marked as WIP since one of the unit tests is failing).
...
- Merged all PRs for Cryptarchia [here](https://github.com/logos-blockchain/logos-blockchain/pull/600) and [here](https://github.com/logos-blockchain/logos-blockchain/pull/583).
...
- KZG core functionality (working version) has been implemented - [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/73).
- Started RS: implemented encoding.
- Started RS: decoding implementation in progress.
- DA API Verified certificate selection from the mempool function - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/598).
- DA API sign attestations in full replication - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/599).
- DA API signer tests - [PR](https://github.com/logos-blockchain/logos-blockchain/pull/601).
