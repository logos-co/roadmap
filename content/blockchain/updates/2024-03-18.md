...
- Stake Relativization Specification - the spec implementation has revealed some bugs in our orphan proof handling logic. Those bugs are still being worked through in this [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/86).
- Refactored Cryptarchia implementation into ledger and consensus crates: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/606).
- Refactored nomos header and block definition so that it's now responsibility of the nomos-core crate: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/609).
- Added Cryptarchia consensus service: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/612).
...
- Integrated mixnet network service for consensus, DA, and mempool: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/610).
- Updated nomos-node integration tests for Mixnet: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/611).
- Refactoring mixnet code: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/614) - and further PRs to be opened soon.
...
- Initial DA API spec structure revised and merged: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/72).
- Tests using DA Protocol specs have been developed. Currently, there are 2 types of tests, which are showcased in the first [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/83) and the second [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/85).
- Finalizing DA verifier protocol specification: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/78).
- Finalizing DA encoding protocol specification: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/76).
- Finalizing DA dispersal protocol specification. Full flow with tests included, using Encoders and Verifiers: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/80). Also, they have gone through reviews and we started discussions in several PRs - [#1](https://github.com/logos-blockchain/logos-blockchain-specs/pull/80), [#2](https://github.com/logos-blockchain/logos-blockchain-specs/pull/81), [#3](https://github.com/logos-blockchain/logos-blockchain-specs/pull/82)
- Added attesters bitfield to DA certificate. Missing compressed bitfield so we can use BLS aggregation of signatures as a threshold scheme: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/81).
