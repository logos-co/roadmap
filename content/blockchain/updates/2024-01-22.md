...
- Completed several PRs (with code-review as well) [Topology](https://github.com/logos-blockchain/logos-blockchain-specs/pull/44), [Sphinx packet construction](https://github.com/logos-blockchain/logos-blockchain-specs/pull/47), [Packet delays](https://github.com/logos-blockchain/logos-blockchain-specs/pull/49), [Mix client Poisson emission](https://github.com/logos-blockchain/logos-blockchain-specs/pull/49). 
...
- Removed the `async-trait` from the [node](https://github.com/logos-blockchain/logos-blockchain/pull/561) as well as [Overwatch](https://github.com/logos-co/Overwatch/pull/33). 
- Grafana and related services addition to the testnet ([new PR](https://github.com/logos-blockchain/logos-blockchain/pull/564)).
- Preparation for demo chat app bot, ability to send data from file, non-interactively ([new PR](https://github.com/logos-blockchain/logos-blockchain/pull/565)).
- [Prune Carnot old block PR](https://github.com/logos-blockchain/logos-blockchain/pull/559) has been completed and is currently in review.
- Added a [test](https://github.com/logos-blockchain/logos-blockchain/pull/563) for big blobs dissemination.
- Limited the number of in-flight requests performed by the chat app to avoid using too many descriptors - more details [here](https://github.com/logos-blockchain/logos-blockchain/pull/562).
