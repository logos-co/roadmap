...
- [PR #691](https://github.com/logos-blockchain/logos-blockchain/pull/691) (Node) - created the aggregated protocols behavior swarm and implemented the DA network backend with the aforementioned libp2p swarm.
...
- [PR #31](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/31) and [PR #33](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/33) (PoCs) - performed optimization of native zones: use basepoint as the blinding point and provide state roots instead of whole state.
- [PR #32](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/32) (PoCs) - built isolated proof scenarios to aid benchmarking work.
- [PR #34](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/34) (PoCs) - aggregated input/output proofs into a single partial transaction proof.
- [PR #35](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/35) (PoCs) - moved the blinding to the partial transaction level instead of blinding each note value individually.
- [PR #36](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/36) (PoCs) - switched from Pederson balance commitments to hash balance commitments.
- [PR #37](https://github.com/logos-blockchain/logos-blockchain-pocs/pull/37) (PoCs) - modelled zone transaction log with MMR.
