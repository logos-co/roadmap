...
- Fixed a [bug](https://github.com/logos-blockchain/logos-blockchain-specs/pull/84) in the Cryptarchia spec regarding `try_create_fork` to find parent block.
- Stake Relativization Executable Specification is done: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/86). Also, implementing stake relativization revealed some bugs in our Cryptarchia spec which took some time to debug and write tests for. Also, the stake relativization spec has been updated with learnings from the implementation (changes were mostly around time management since we need the inferred total stake to be stable by the time we enter the next epoch).
...
- Some refactoring work on following PRs: [#615](https://github.com/logos-blockchain/logos-blockchain/pull/615), [#616](https://github.com/logos-blockchain/logos-blockchain/pull/616), [#618](https://github.com/logos-blockchain/logos-blockchain/pull/618).
...
- Fixed a new storage issue in windows build CI: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/621 "https://github.com/logos-blockchain/logos-blockchain/pull/621").
- Added a new block subscription to consensus service: [PR](https://github.com/logos-blockchain/logos-blockchain/pull/617 "https://github.com/logos-blockchain/logos-blockchain/pull/617").
- DA API testing: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/83 "https://github.com/logos-blockchain/logos-blockchain-specs/pull/83").
- Added Certificate verification to specs: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/82 "https://github.com/logos-blockchain/logos-blockchain-specs/pull/82").
- Fixed arbitrary data encoding in the Encoder specs: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/87 "https://github.com/logos-blockchain/logos-blockchain-specs/pull/87"). There was an issue with this, we can only encode up to 31bytes per chunk using bls. Notice that bls uses 32bytes field elements, but some 32bytes elements would be higher than the bls_modulus, hence we need to use 31bytes.
- Added duplicated blobs verification in verifier: Verifiers need to return the attestation in case a duplicated verification comes around, or skip it depending on different stages: [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/88 "https://github.com/logos-blockchain/logos-blockchain-specs/pull/88").
...
- Removed unused nomos services: old metrics service replaced with a Prometheus [PR](https://github.com/logos-blockchain/logos-blockchain/pull/623) and old http API removed [PR](https://github.com/logos-blockchain/logos-blockchain/pull/622).
