...
- Fixed the race for nomos log service [PR](https://github.com/logos-blockchain/logos-blockchain/pull/577).
- Nomos-cli: Integrated the explorer into the nomos-cli in one [PR](https://github.com/logos-blockchain/logos-blockchain/pull/578) with the integration tests coming in [another one](https://github.com/logos-blockchain/logos-blockchain/tree/integration-for-explorer) once it is unblocked (blocked due to the `sled` dependency).

## `cryptarchia`

### `research`

- New details have been added to the Cryptarchia specification: [the epoch transition](https://github.com/logos-blockchain/logos-blockchain-specs/pull/63), [nonce specification](https://github.com/logos-blockchain/logos-blockchain-specs/pull/64), [orphan proofs validation](https://github.com/logos-blockchain/logos-blockchain-specs/pull/69), [leader lottery VRF details](https://github.com/logos-blockchain/logos-blockchain-specs/pull/68), [leader coin evolution](https://github.com/logos-blockchain/logos-blockchain-specs/pull/65). With these additions, the [Cryptarchia v1](https://www.notion.so/Cryptarchia-Specifications-a11d16a37c81452a8c89a94ced3ceef5) is now ready internally.
...
- The DA specification has been updated with new details. To see them and, in general, the progress of the DA specification, refer to this [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/70).
