...
- After careful consideration and discussion, the [topology update](https://github.com/logos-blockchain/logos-blockchain-specs/pull/56) and [public APIs](https://github.com/logos-blockchain/logos-blockchain-specs/pull/57) PRs for core logic have been merged.

### `development`

- Added a utilities function of python mixnet to rust [PR](https://github.com/logos-blockchain/logos-blockchain/pull/575). Currently in review.

## `testnet`

### `development`

- Additional polishing (route separation) of the Naive blocks query implementation from the storage layer [PR](https://github.com/logos-blockchain/logos-blockchain/pull/566).
- Added DA API for Explorer, while removing the unused API [PR](https://github.com/logos-blockchain/logos-blockchain/pull/576) - currently in review.
- [Integrated](https://github.com/logos-blockchain/logos-blockchain/tree/integrate-explorer) the block explorer into the demo. Currently thinking about writing integration tests for it.
- Testnet fixes [PR](https://github.com/logos-blockchain/logos-blockchain/pull/574): the testnet ran on Linux with no issues; however, several fixes were needed for it to work on MacOS (about Grafana, Nomos chat bot params, and Nomos chat OpenSSL libs build version).
...
- Added the fork choice rule [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/58) as described in "Ouroboros Genesis: Composable Proof-of-Stake Blockchains with Dynamic Availability". Tests will be added later.
- "Follower maintains ledger state as it follows the blockchain" [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/62). Leader coins are now spent when they become slot leaders. The next step is to have the leaderproof produce a new coin that the validator can then use to lead another slot.
- Merged the "Add header ID and message" [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/52).
...
- Merged a mandatory [PR](https://github.com/logos-blockchain/logos-blockchain-specs/pull/60) containing a big chunk of primitives from the ETH specification that's a dependency for building our DA specification. It will help us save a good amount of time during our implementation (and testing) of everything.
...
- The sketch of the DA layer can be seen in this [branch](https://github.com/logos-blockchain/logos-blockchain-specs/tree/da-specs).
